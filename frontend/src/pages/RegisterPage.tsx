...
const RegisterPage = () => {
  ...
  return (
    <main className="w-full min-h-[calc(100vh-4.5rem)] flex justify-center items-center p-4 sm:p-6">
      <section className="w-full max-w-md bg-white text-second-text rounded-2xl shadow-md p-6 font-medium my-auto">
        <h2 className="text-xl sm:text-2xl text-center font-semibold mb-6">Register new account</h2>
