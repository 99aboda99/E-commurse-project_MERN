  ...
  return (
    <div className="relative w-full h-17.5 bg-primary flex justify-between items-center flex-row z-40">
      <a href="/" className="flex items-center flex-row ml-5 gap-3">
        ...
        />
        <h1 className="text-2xl text-white font-bold hidden md:block">Shopify</h1>
      </a>
      ...
      <div className="relative mr-5" ref={menuRef}>
        <button
          ...
          className="flex items-center justify-center w-10 h-10 cursor-pointer rounded-full bg-red-900 text-white font-bold shrink-0 hover:ring-2 hover:ring-white/60 transition-all focus:outline-none"
